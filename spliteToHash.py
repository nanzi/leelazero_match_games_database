...
outputFolder = "MatchGames"

if not os.path.exists(outputFolder) :
    os.makedirs(outputFolder)
    
labelM = "match" # CHANGE ME  1M~20M... and so on (tar file location of games) 
...
while j:
    ...
    while i<clipLen:
        ...
        if gameInfo[CountPW][0:2]=="PW": #  need to locate and fix broken sgf record with (grep "7ba9d22c\]PB\[" mSGFs/all_2M.sgf -n)
            ...
            playerW = str(gameInfo[CountPW][-8:])
